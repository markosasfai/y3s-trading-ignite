...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "20.–24. júl 2026, 18:00. Dodo a Lukáš ťa za 5 dní naučia zarábať obchodovaním. 100 % online a zdarma. Obmedzený počet miest." },
      { property: "og:title", content: "Zero to Hero — 5-dňový online challenge zdarma | Y3S × Chalan z Burzy" },
      { property: "og:description", content: "20.–24. júl 2026, 18:00. Dodo a Lukáš ťa za 5 dní naučia zarábať obchodovaním. 100 % online a zdarma. Obmedzený počet miest." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "Zero to Hero — 5-dňový online challenge zdarma | Y3S × Chalan z Burzy" },
      { name: "twitter:description", content: "20.–24. júl 2026, 18:00. Dodo a Lukáš ťa za 5 dní naučia zarábať obchodovaním. 100 % online a zdarma. Obmedzený počet miest." },
