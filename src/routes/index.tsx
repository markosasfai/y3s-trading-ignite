...
function Index() {
  return (
    <main className="relative min-h-screen text-foreground lg:h-screen lg:overflow-hidden">
      ...
      <div className="mx-auto flex h-full max-w-[1680px] flex-col gap-6 px-4 py-5 sm:px-6 lg:grid lg:grid-cols-[minmax(0,1.08fr)_minmax(0,0.92fr)] lg:gap-10 lg:px-8 lg:py-5">
        {/* Header (mobile) */}
        ...
        <section className="relative flex items-center justify-center lg:h-full">
          ...
          <div className="glass-strong relative overflow-hidden rounded-3xl p-2 glow-orange lg:p-2.5">
            <img
              ...
              className="block h-full max-h-[min(87vh,980px)] w-auto rounded-2xl object-contain"
            />
          </div>
        </section>
        ...
        <section className="flex min-h-0 flex-col justify-center lg:h-full">
          <div className="flex min-h-0 flex-col justify-center gap-4 lg:gap-4.5">
          <div className="space-y-3">
            <div className="hidden items-center justify-between gap-4 lg:flex">
              <img src={logoAsset.url} alt="Y3S × Chalan z Burzy" className="h-20 w-auto" />
              <LivePill />
            </div>
            <p className="font-display text-base uppercase tracking-[0.28em] text-primary lg:text-xl">
              Y3S × Chalan z Burzy uvádzajú
            </p>
            <h1 className="font-display text-[clamp(3.3rem,5.8vw,6.6rem)] font-black leading-[0.88] tracking-normal">
              <span className="block">ZERO TO</span>
              <span className="block text-gradient-orange">HERO</span>
            </h1>
            <p className="font-display text-2xl uppercase tracking-[0.12em] text-foreground/90 lg:text-3xl">
