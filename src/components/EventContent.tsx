      ...
      {DAYS.map((d) => (
        ...
        >
          ...
          <div className="flex flex-col items-center gap-0.5 opacity-55">
            ...
            <span className="text-[0.85rem] font-semibold leading-tight text-foreground/60">
              {d.date}
            </span>
          </div>
        </div>
