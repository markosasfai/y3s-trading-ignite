...
const DAYS = [
  {
    ...
    dayOfWeek: "Pondelok",
    date: "20. júl",
    title: "Základy & PROP účty",
  },
  {
    n: 2,
    dayOfWeek: "Utorok",
    date: "21. júl",
    title: "Sviečky & fundamenty",
  },
  {
    n: 3,
    dayOfWeek: "Streda",
    date: "22. júl",
    title: "Risk & psychológia",
  },
  {
    n: 4,
    dayOfWeek: "Štvrtok",
    date: "23. júl",
    title: "Trendy & SR zóny",
  },
  {
    n: 5,
    dayOfWeek: "Piatok",
    date: "24. júl",
    title: "Techniky & FINÁLE",
  },
];
    ...
    <div className="grid grid-cols-2 gap-3 sm:grid-cols-3 lg:grid-cols-5">
      {DAYS.map((d) => (
        ...
        >
          ...
          <h3 className="text-[0.82rem] font-black leading-tight text-foreground sm:text-[0.92rem] lg:text-[0.95rem]">
            {d.title}
          </h3>
